        ...
        <div class="page-container">
            ...
            <section class="p-t-10">
                ...
                <form class="form-header" action="?" method="POST">
                    ...
                    <input style="margin-left:5px;" type="submit" class="au-btn au-btn-icon au-btn--green au-btn--small" value="Procurar">
                </form>
               </center>
                                ...
                                <div class="table-data__tool-right">
                                    ...
                                    <a href="add_produtos.php"><button class="au-btn au-btn-icon au-btn--green au-btn--small">
