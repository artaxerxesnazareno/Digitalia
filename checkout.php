                    ...
                    <ul class="list-unstyled list-inline">
                        <li class="dropdown dropdown-small">
                            <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" href="#"><span
                                        class="key"><?php if (isset($_SESSION)) {
                                        echo "$Semail";
                                    } ?> </span></a>
                        </li>
                    </ul>
            ...
            <div class="col-sm-6">
                <div class="shopping-item">
                    <a href="cart.php">Cart - <span class="cart-amunt"><?php
                            ...
                            echo number_format($final, 2, ',', '.'); ?> kz</span> <i class=" shopping-cart"></i> <span
                                class="product-count"><?php echo $conta ?></span></a>
                </div>
            </div>
        </div>
    </div>
...
-->
                        ...
                        <form action="encomenda.php" class="checkout" method="post"
                              name="checkout">
                                        ...
                                        <!--
                                                                                <p id="billing_country_field"
                                                                                   class="form-row form-row-wide address-field update_totals_on_change validate-required woocommerce-validated">
                                                                                    <label class="" for="billing_country">País <abbr title="required"
                                                                                                                                     class="required">*</abbr>
                                                                                    </label>
                                        ...
                                        <!--
                                                                                <p id="billing_company_field" class="form-row form-row-wide">
                                                                                    ...
                                                                                    <input type="text" value="" placeholder="" id="billing_company"
                                                                                           name="nempresa" class="input-text ">
                                                                                </p>
       ...
       class="form-row form-row-wide address-field validate-required">
                                            ...
                                            <input type="text" value="" placeholder="Endereço da Rua"
                                                   id="billing_address_1" name="endereco" class="input-text ">
                                        </p>
<!--
                                        <p id="billing_address_2_field" class="form-row form-row-wide address-field">
                                            <input type="text" value=""
                                                   placeholder="Apartment, suite, unit etc. (optional)"
                                                   id="billing_address_2" name="endereco2" class="input-text ">
                                        </p>
                   ...
                   -->                     <p id="billing_city_field"
                                           ...
                                           data-o_class="form-row form-row-wide address-field validate-required">
                                            ...
                                            <input type="text" value="" placeholder="Cidade" id="billing_city"
                                                   name="cidade" class="input-text ">
                                        </p>
                                   ...
                                   <!--     <p id="billing_state_field"
                                           ...
                                           data-o_class="form-row form-row-first address-field validate-state">
                                            ...
                                            <input type="text" id="billing_state" name="condado"
                                                   placeholder="Estado / País" value="" class="input-text ">
                                        </p>-->
                                        <!--<p id="billing_postcode_field"
                                           ...
                                           data-o_class="form-row form-row-last address-field validate-required validate-postcode">
                                            <label class="" for="billing_postcode">CEP <abbr title="required"
                                                                                             class="required">*</abbr>
                                            </label>
                                            <input type="text" value=""
                                                   placeholder="Código de Endereçamento Postal / CEP"
                                                   id="billing_postcode" name="cep" class="input-text ">
                                        </p>-->
                                       ...
                                       <!-- <p id="billing_email_field"
                                           class="form-row form-row-first validate-required validate-email">
                                            <label class="" for="billing_email">Endereço de email <abbr title="required"
                                                                                                        class="required">*</abbr>
                                            </label>
...
-->
                                        <p id="billing_phone_field"
                                           class="form-row form-row-last validate-required validate-phone">
                                            <label class="" for="billing_phone">Telefone <abbr title="required"
                                                                                               class="required">*</abbr>
                                            </label>
                                            <input type="text" value="" placeholder="" id="billing_phone"
                                                   name="telefone" class="input-text ">
                                        </p>
                                        <div class="clear"></div>
                            ...
                            <div id="order_review" style="position: relative;">
                                <table class="shop_table">
                                    ...
                                    <tr class="cart-subtotal">
                                        ...
                                        <td>
                                            <span class="amount">kz <?php echo number_format($final, '2', ',', '.'); ?></span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="order-total">
                                        ...
                                        <td><strong><span
                                                        class="amount">kz <?php echo number_format($final, '2', ',', '.'); ?></span></strong>
                                        </td>
                                    </tr>
...
-->
                                    <div class="form-row place-order">
                                        ...
                                        <input type="submit" data-value="Place order" value="Faça a encomenda"
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="footer-newsletter">
                    ...
                    <p>Assine nossa newsletter e receba ofertas exclusivas que você não encontrará em nenhum outro lugar
                        diretamente na sua caixa de entrada!</p>
...
<div class="footer-bottom-area">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="copyright">
                    <p>&copy; 2015 eElectronics. All Rights Reserved. Coded with <i class=" heart"></i> by <a
